...
const DndScreen = () => {
  ...
  const [availableCommands, setAvailableCommands] = React.useState([
    { 
      id: 1, 
      text: "Avanzar", 
      description: "El robot avanza un paso hacia adelante",
      type: "avanzar",
      canDuplicate: true
    },
    { 
      id: 2, 
      text: "Girar Derecha", 
      description: "El robot gira 90¬∞ hacia la derecha",
      type: "girarderecha",
      canDuplicate: true
    },
    { 
      ...
      description: "El robot gira 90¬∞ hacia la izquierda",
      type: "girarizquierda",
      canDuplicate: true
    },
    { 
      id: 4, 
      text: "Recoger/Soltar", 
      description: "El robot recoge o suelta un objeto",
      type: "recogersaltar",
      canDuplicate: true
    },
    { 
      id: 5, 
      text: "Transferir Objeto", 
      description: "Recoge un objeto de un escritorio y lo lleva a otro",
      type: "transferirObjeto",
      canDuplicate: true
    },
    { 
      id: 6, 
      text: "Repetir 3 Veces", 
      description: "Repite los comandos anidados tres veces",
      type: "repetir",
      canDuplicate: true,
      nestedCommands: []
    },
    { 
      id: 7, 
      text: "Si Hay Obstáculo", 
      description: "Ejecuta comandos si hay un obstáculo adelante",
      type: "sihayobstaculo",
      canDuplicate: true,
      nestedCommands: []
    },
    { 
      id: 8, 
      text: "Si Hay Objeto", 
      description: "Ejecuta comandos si hay un objeto adelante",
      type: "sihayobjeto",
      canDuplicate: true,
      nestedCommands: []
    },
  ...
  const [programSequence, setProgramSequence] = React.useState([]);
  ...
  const moveFromAvailableToSequence = (itemId, insertIndex) => {
    ...
    if (clonedItem.type === 'repetir' || clonedItem.type === 'sihayobstaculo' || clonedItem.type === 'sihayobjeto') {
  ...
  return (
    <div className="program-robot-screen">
      ...
      <div className="program-controls">
        <button className="play-button" onClick={handleRunProgram}>
          ▶️ Ejecutar Programa
        </button>
        
        <button className="control-button reset-button" onClick={handleClearProgram}>
          🗑️ Borrar Programa
        </button>
      </div>
    </div>
