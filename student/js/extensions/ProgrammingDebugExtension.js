class ProgrammingDebugExtension extends Extension {
    ...
    createDebugInfo() {
        ...
        const stepsLine = this.createElement('div', {}, [
            'PASOS: ',
            this.createElement('span', { id: 'debug-steps' }, ['0'])
        ]);
        debugInfo.appendChild(stepsLine);
    }
}

window.__extensions = window.__extensions || [];
window.__extensions.push({
    name: 'ProgrammingDebug',
    constructor: ProgrammingDebugExtension
});
